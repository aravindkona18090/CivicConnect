...
<head>
    ...
    <title><?php echo $lang[$selectedLang]['admin_login']; ?> - CivicConnect</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .neu-icon {
            ...
            background: var(--amber-gradient); border-radius: 20px;
        ...
        .input-group input:focus { border-color: var(--amber-primary); box-shadow: 0 0 0 4px var(--focus-ring); }
        .input-icon { position: absolute; left: 16px; color: var(--text-muted); pointer-events: none; }
        .submit-btn {
            width: 100%; padding: 16px; background: var(--amber-gradient); color: #ffffff;
            border: none; border-radius: 12px; font-size: 1rem; font-weight: 700; font-family: inherit;
            cursor: pointer; box-shadow: 0 4px 14px rgba(217, 119, 6, 0.35); transition: all 0.25s ease;
            display: flex; align-items: center; justify-content: center; gap: 10px; margin-top: 10px;
        }
        .submit-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(217, 119, 6, 0.45); }
        .login-footer { text-align: center; margin-top: 24px; font-size: 0.9rem; color: var(--text-muted); }
        .login-footer a { color: var(--amber-primary); font-weight: 700; text-decoration: none; }
    ...
    <div class="login-container">
        ...
        <div class="login-card">
            <div class="login-header">
                <div class="neu-icon">
                    <i class="fa-solid fa-user-shield" style="font-size:1.5rem; color:#fff;"></i>
                </div>
                <h2><?php echo $lang[$selectedLang]['admin_login']; ?></h2>
                <p><?php echo $lang[$selectedLang]['admin_welcome']; ?></p>
            </div>
